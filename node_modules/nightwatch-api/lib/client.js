...
var _assertionError = _interopRequireDefault(require("assertion-error"));
...
async function createSession(options) {
  ...
  client = (0, _nightwatch.client)(settings, new _reporter.default());
...
async function handleQueueResult(err, resolve, reject) {
  ...
  if (!(err instanceof _assertionError.default) || err.abortOnFailure) {
    resetQueue();
  }
